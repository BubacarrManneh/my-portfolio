    ...
    <div  className="text-gray-100 leading-normal tracking-wider bg-cover lg:mb-0"
      ...
      <div className='justify-around flex flex-wrap pt-6'>
        <div>
          ...
          <iframe height='250' width='400' className='rounded-2xl mb-6 pt-3' title='portfolio' src='http://bubacarrm.netlify.app'></iframe>
        </div>
        <div>
          <p>
          ...
          <iframe height='250' width='400' className='rounded-2xl mb-6 pt-3' title='portfolio' src='http://bubacarrtodo.netlify.app'></iframe>
        </div>
        <div>
          <p><a href='http://albuba.netlify.app' target='_blank' rel="noreferrer" ><button className='bg-sky-500 p-3 rounded-lg'>My website</button></a></p>
           <iframe height='250' width='400' className='rounded-2xl mb-6 pt-3' title='portfolio' src='http://albuba.netlify.app'></iframe>
        </div>
        <div>
          ...
          <iframe height='250' width='400' className='rounded-2xl mb-6 pt-3' title='portfolio' src='http://abuweather.netlify.app'></iframe>
        </div>    
      </div>
    </div>
  );
